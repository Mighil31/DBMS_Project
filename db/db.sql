...
insert into sales_cust values(1, 6);
insert into sales_cust values(2, 7);
insert into sales_cust values(3, 8);
insert into sales_cust values(4, 9);
insert into sales_cust values(5, 10);


alter table products add column image varchar(50);


{
    "user_name": "salesperson1",
    "passwd": "salesperson1",
    "user_type": "SP"
}

{
    "user_name": "salesclerk4",
    "passwd": "salesclerk4",
    "user_type": "Sc"
}
